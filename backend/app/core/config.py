...
from pydantic import AliasChoices, Field         # The imported classes create a settings class that values from the .env file 
...
class Settings(BaseSettings):
    ...
    SECRET_KEY: str = "DEFAULT_SECRET_KEY_FOR_DEV_REPLACE_ME"
