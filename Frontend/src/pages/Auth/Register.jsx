    ...
    <div className="relative grid min-h-screen place-items-center bg-slate-950 px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Start planning smarter today</p>
        </div>
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="firstName" className="mb-1.5 block text-xs font-medium text-slate-300">
                First name
              </label>
              <input
                id="firstName"
            ...
            <div>
              <label htmlFor="lastName" className="mb-1.5 block text-xs font-medium text-slate-300">
                Last name
              </label>
              <input
                id="lastName"
